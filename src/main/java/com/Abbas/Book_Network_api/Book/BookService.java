...
import com.Abbas.Book_Network_api.File.FileStorageService;
import com.Abbas.Book_Network_api.History.BookTransactionHistory;
import com.Abbas.Book_Network_api.History.BookTransactionHistoryRepository;
...
import static com.Abbas.Book_Network_api.Book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public PageResponse<BookResponse> findAllBooks(int page, int size, Authentication connectedUser) {
        ...
        Page<Book> books = bookRepository.findAllDisplayableBooks((java.awt.print.Pageable) pageable, connectedUser.getName());
