...
public interface BookTransactionHistoryRepository  extends JpaRepository<BookTransactionHistory, Integer> {
    ...
    @Query("""
            ...
            """)
    Page<BookTransactionHistory> findAllBorrowedBooks(SpringDataWebProperties.Pageable pageable, String  userId);
    @Query("""
            SELECT history
            FROM BookTransactionHistory history
            WHERE history.book.createdBy = :userId
            """)
    Page<BookTransactionHistory> findAllReturnedBooks(SpringDataWebProperties.Pageable pageable, String userId);
}
